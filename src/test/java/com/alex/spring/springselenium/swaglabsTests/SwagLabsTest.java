...
import com.alex.spring.springselenium.kelvin.annotations.LazyAutowired;
import com.alex.spring.springselenium.pages.swaglabs.SwagLabsPage;
import com.alex.spring.springselenium.kelvin.service.ScreenshotService;
...
public class SwagLabsTest extends SpringBaseTestNGTest {
    ...
    @LazyAutowired //Manual Annotation
